export default {
  ...
  MISSING_SIGNATURE: { message: "Missing signature for upload. The SDK expects signature for authentication.", help: ""},
  MISSING_TOKEN: { message: "Missing token for upload. The SDK expects token for authentication.", help: ""},
  MISSING_EXPIRE: { message: "Missing expire for upload. The SDK expects expire for authentication.", help: ""},
};
